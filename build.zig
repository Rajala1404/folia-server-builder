...
pub fn build(b: *std.Build) void {
    ...
    // const target_windows_aarch64 = std.zig.CrossTarget{ .os_tag = .windows, .cpu_arch = .aarch64 };
    // const target_windows_arm = std.zig.CrossTarget{ .os_tag = .windows, .cpu_arch = .arm };
    ...
    //     .optimize = optimize,
    // });
    // const windows_aarch64 = b.addExecutable(.{
    //     .name = "folia-server-builder_windows_aarch64",
    //     .root_source_file = .{ .path = "src/main.zig" },
    //     .target = target_windows_aarch64,
    //     .optimize = optimize,
    // });
    // const windows_arm = b.addExecutable(.{
    //     .name = "folia-server-builder_windows_arm",
    //     .root_source_file = .{ .path = "src/main.zig" },
    //     .target = target_windows_arm,
    //     .optimize = optimize,
    // });
    ...
    // b.installArtifact(windows_aarch64);
    // b.installArtifact(windows_arm);
    ...
    // all_step.dependOn(&windows_aarch64.step);
    // all_step.dependOn(&windows_arm.step);
    //macOS
